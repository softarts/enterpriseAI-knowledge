"""BAAI/bge-m3 implementation of the common Embedder interface."""

from typing import List, Optional, Sequence


class BgeM3Embedder:
    def __init__(self, model_name: str = "BAAI/bge-m3", dimension: int = 1024, normalize_embeddings: bool = True, batch_size: int = 32, model: object = None, **_: object):
